...
`
		...
		require.Equal(t, math.LegacyMustNewDecFromStr("3.04"), prices[OJOUSDT].Price)
		require.Equal(t, math.LegacyMustNewDecFromStr("1827884.77"), prices[OJOUSDT].Volume)
	})
